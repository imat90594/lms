...
function lms_preprocess_html (&$variables) {
	
}


function lms_preprocess_page (&$variables) {
	...
	$variables['main_navigation'] = _lms_get_main_navigation();
...
function lms_preprocess_block (&$variables) {

}

function lms_preprocess_node (&$variables) {
...
function lms_theme() {
	return array(
			...
			'commerce_checkout_form_checkout' => array(
					    ...
					    'path' 			 => drupal_get_path('theme', 'lms') . '/templates/pages/commerce',
			),
			...
			'commerce_checkout_form_complete' => array(
					...
					'user_profile_form' => array(
					      ...
					      'path' 			 => drupal_get_path('theme', 'lms') . '/templates/pages/user-profile',
			),
			...
			'user_login' => array(
					      ...
					      'render element' => 'form',
					      'template' => 'user-login',
					      'path' 			 => drupal_get_path('theme', 'lms') . '/templates/pages/user',
			),
...
function _lms_get_main_navigation() {
	$html = '';
...
function lms_form_commerce_checkout_form_checkout_alter(&$form, &$form_state, $form_id) {
	$form['buttons']['continue']['#value'] = "PLACE ORDER";
}

function lms_element_info_alter(&$elements) {
