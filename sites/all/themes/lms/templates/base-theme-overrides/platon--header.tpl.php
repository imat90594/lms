		...
		<header id="site-header"<?php print $site_header_attributes; ?>>
			<div class="row">
				<div class="col col-2-out-of-2 col-4-out-of-4 col-6-out-of-6 header-user-tools">
					...
					<span class="welcome hidden-mobile"><?php print t("welcsome @user", array('@user' => $logged_in ? $user->name : t("guest"))); ?></span>
					</div>
					</div>
				</div>
			</div>
			...
			<div class="container">
				...
				<div class="navbar-header">
				   <button type="button" class="navbar-toggle" data-toggle="offcanvas" data-target=".sidebar-nav">
					...
					<a class="navbar-brand" href="<?php print $front_page; ?>" id="logo"><img src="<?php print $logo; ?>" alt="Opigno"></a>
				</div>
				<div class="nav navbar-nav navbar-right">
					<a class="btn btn-primary" href="<?php print url('user'); ?>"><span class="glyphicon glyphicon-user"></span> ACCOUNT</a>
				</div>
			</div>
		</div>
